...
import rule from './forbidden.rule';
...
describe('@angular-eslint/template-parser', () => {
    ...
    testWithAngularTemplateParser.run('html-class-attribute/forbidden with LF', rule, {
        valid,
        invalid,
    });
});
...
describe('@html-eslint/parser', () => {
    ...
    testWithHtmlParser.run('html-attributes-order/forbidden with LF', rule, {
        valid,
        invalid,
    });
});
